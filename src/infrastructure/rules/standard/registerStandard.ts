...
import { makeMarkdownLintAdapter, type MarkdownLintAdapter } from "./MarkdownLintAdapter.js";
 ...
 */
export const STANDARD_RULE_DESCRIPTORS: readonly StandardRuleDescriptor[] = Object.freeze([
  {
    code: "MD001",
